const FinancialAidSection = ({ onNavigate }: any) => (
 <div className="max-w-[1400px] mx-auto w-full mt-16">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
    {/* Scholarship Card 1 */}
    <div className="scholarship-card bg-white rounded-xl shadow-[0_2px_15px_rgb(0,0,0,0.04)] p-4 w-full border border-gray-100 flex flex-col h-full hover:-translate-y-1 transition-transform duration-300 cursor-pointer">
      <div className="w-full h-28 mb-3 rounded-lg overflow-hidden relative group shrink-0">
        <img
      ...
      <div className="mb-3 shrink-0">
        ...
        >
          National IT Excellence Scholarship (BSc. CSIT)
        </h2>
      ...
      <div className="grid grid-cols-2 gap-2 text-xs text-gray-600 mb-4 bg-gray-50/80 p-2.5 rounded-lg border border-gray-100 flex-1 content-start">
        ...
        <div className="flex items-center gap-1.5 col-span-2 xl:col-span-1">
          ...
          <span className="font-medium text-gray-800 truncate">Bagmati</span>
        </div>
        ...
        <div className="flex items-center gap-1.5 col-span-2">
          ...
          <span className="font-medium text-red-600">Ends: Aug 15, 2026</span>
        </div>
      </div>
      <div className="flex gap-1.5 mt-auto pt-1 shrink-0">
        <button className="flex-1 px-2 py-2 bg-white border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-gray-100 transition-all text-[13px] text-center">
          Details
        </button>
