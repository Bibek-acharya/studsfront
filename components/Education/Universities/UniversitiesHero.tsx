      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-20 w-full animate-fadeInUp">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl font-medium leading-relaxed">
            Search through over 1,500+ affiliated colleges across Nepal and top
            international universities. Map your academic future today.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-6 text-white/80">
            ...
            <button
              onClick={() => onSearch("TU")}
              className="text-sm font-bold border-b border-white/20 hover:border-white transition-colors"
            >
              TU Affiliated
            </button>
            <button
