...
const ForumSidebar: React.FC<ForumSidebarProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
        ...
        <nav className="space-y-1">
          {[
            ...
            { label: "Courses", icon: "fa-solid fa-building-columns" },
            { label: "Admission", icon: "fa-solid fa-building-columns" },
            { label: "Scholarship", icon: "fa-solid fa-building-columns" },
            { label: "Events", icon: "fa-solid fa-building-columns" },
            { label: "Entrance Exam", icon: "fa-solid fa-building-columns" },
            { label: "Exam Programs", icon: "fa-solid fa-building-columns" },
            { label: "Campus Life", icon: "fa-solid fa-building-columns" },
            { label: "Academics", icon: "fa-solid fa-building-columns" },
            { label: "General", icon: "fa-solid fa-building-columns" },
          ].map((cat) => (
            <button
              key={cat.label}
      ...
      {/* Analytics Graphic placeholder from Screenshot 4 */}
