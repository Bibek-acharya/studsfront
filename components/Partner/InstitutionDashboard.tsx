...
import InstitutionLayout, { InstitutionPage } from "./institution/InstitutionLayout";
...
const InstitutionDashboard: React.FC = () => {
  ...
  const renderPage = () => {
    switch (activePage) {
      ...
      case "admissionManage":   return <AdmissionManagePage />;
      case "program":           return <ProgramPage />;
      case "collegeProfile":    return <CollegeProfilePage />;
      case "counselling":       return <CounsellingPage />;
      case "entrance":          return <EntrancePage />;
      case "events":            return <EventsPage />;
      case "newsNotice":        return <NewsNoticePage />;
      case "qms":               return <QMSPage />;
      case "scholarship":       return <Placeholder title="Scholarship Applications" />;
      case "scholarshipManage": return <ScholarshipSectionContainer />;
      case "message":           return <Placeholder title="Messages" />;
