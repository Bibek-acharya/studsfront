    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center fixed w-full top-0 z-10 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl text-gray-900 tracking-tight">Provider Portal</span>
        </div>
        <div className="flex items-center gap-6">
          <div className="hidden sm:flex items-center gap-3">
            <div className="text-right">
              <p className="text-sm font-bold text-gray-900">{providerUser.provider_name}</p>
              <p className="text-xs text-gray-500 font-medium">{providerUser.email}</p>
            </div>
          </div>
          <button 
      ...
      <main className="flex-1 mt-[72px] p-6 max-w-7xl mx-auto w-full">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Welcome, {providerUser.provider_name}</h1>
          <p className="text-gray-500 mt-1">Manage your scholarships and applicants here.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col h-full">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold text-gray-900">Active Scholarships</h3>
            ...
            <div className="mt-auto">
              ...
              <p className="text-sm text-gray-500 font-medium mt-1">Published listings</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col h-full">
            ...
            <div className="mt-auto">
              <span className="text-4xl font-black text-gray-900">0</span>
              <p className="text-sm text-gray-500 font-medium mt-1">Across all scholarships</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col h-full">
            ...
            <div className="mt-auto">
              <span className="text-4xl font-black text-gray-900">0</span>
              <p className="text-sm text-gray-500 font-medium mt-1">Unread messages</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 flex flex-col items-center justify-center text-center py-20">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">No Scholarships Yet</h3>
          <p className="text-gray-500 max-w-sm mb-6">You haven't added any scholarships to the platform yet. Set up your first scholarship to start receiving applications.</p>
